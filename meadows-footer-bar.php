...
function footer_bar_styles() {
    wp_register_style( 'new_style', plugins_url('./meadows-footer-bar.css', __FILE__), false, '1.13', 'all');
}
...
function footer_bar_scripts() {
    wp_enqueue_script( 'footer-bar-js', plugins_url( './meadows-footer-bar.js', __FILE__ ), false, '1.13', 'all');
}
